                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                            ...
                            ?>
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="../konfigurasi_sistem/">Konfigurasi Sistem</a> <span class="divider">/</span></li>
                                    <li class="active">Log Book</li>
                                </ul> 
                            
                            <p align="right">
                                    <a href="#clearLog" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-remove-sign"></i>&nbsp;Kosongkan Log!</button></a> 
                                </p>
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                <thead>
                                    <tr id="theadBasic">
                                        <td id="thead">No</td>
                                        <td id="thead">username</td>
                                        <td id="thead">Catatan Waktu</td>
                                        <td id="thead">Aktivitas</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/logBookView.php";
                                    ?>
                                </tbody>
                            </table>
                                <?php
                                
                                include "../../../data/view/kosongkanLogViewModal.php";
