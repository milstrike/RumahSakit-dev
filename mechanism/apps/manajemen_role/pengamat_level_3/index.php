...
<html>
    <head>
        ...
        include "../../../../data/editLevel3Pengamat.php";
        include "../../../../data/deleteLevel3Pengamat.php";
        include "../../../../data/resetLevel3Pengamat.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Pengamat Level 3</li>
                                </ul>
                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel3PengamatView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel3PengamatViewModal.php";
                                include "../../../../data/view/editLevel3PengamatViewModal.php";
                                include "../../../../data/view/deleteLevel3PengamatViewModal.php";
                                include "../../../../data/view/resetLevel3PengamatViewModal.php";
                            ?>
