...
<html>
    <head>
        ...
        include "../../../../data/editLevel2Account.php";
        include "../../../../data/deleteLevel2Account.php";
        include "../../../../data/resetLevel2Password.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Level 2</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel2View.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel2ViewModal.php";
                                include "../../../../data/view/editLevel2AccountViewModal.php";
                                include "../../../../data/view/deleteLevel2AccountModal.php";
                                include "../../../../data/view/resetLevel2PasswordViewModal.php";
                                include "../../../../data/view/userLevel2EditRoleViewModal.php";
                            ?>
