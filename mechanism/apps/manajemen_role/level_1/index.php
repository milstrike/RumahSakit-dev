...
<html>
    <head>
        ...
        include "../../../../data/editLevel1Account.php";
        include "../../../../data/deleteLevel1Account.php";
        include "../../../../data/resetLevel1Password.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Level 1</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel1View.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel1ViewModal.php";
                                include "../../../../data/view/editLevel1AccountViewModal.php";
                                include "../../../../data/view/deleteLevel1AccountModal.php";
                                include "../../../../data/view/resetLevel1PasswordViewModal.php";
                            ?>
