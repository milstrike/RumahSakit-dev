...
<html>
    <head>
        ...
        include "../../../../data/editLevel3Account.php";
        include "../../../../data/deleteLevel3Account.php";
        include "../../../../data/resetLevel3Password.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Level 3</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel3View.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel3ViewModal.php";
                                include "../../../../data/view/editLevel3AccountViewModal.php";
                                include "../../../../data/view/deleteLevel3AccountModal.php";
                                include "../../../../data/view/resetLevel3PasswordViewModal.php";
                                include "../../../../data/view/userLevel3EditRoleViewModal.php";
                            ?>
