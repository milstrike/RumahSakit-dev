...
<html>
    <head>
        ...
        include "../../../../data/editLevel2Pengamat.php";
        include "../../../../data/deleteLevel2Pengamat.php";
        include "../../../../data/resetLevel2Pengamat.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Pengamat Level 2</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel2PengamatView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel2PengamatViewModal.php";
                                include "../../../../data/view/editLevel2PengamatViewModal.php";
                                include "../../../../data/view/deleteLevel2PengamatViewModal.php";
                                include "../../../../data/view/resetLevel2PengamatViewModal.php";
                            ?>
