...
<html>
    <head>
        ...
        include "../../../../data/editLevel4Account.php";
        include "../../../../data/deleteLevel4Account.php";
        include "../../../../data/resetLevel4Password.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Level 4</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                <thead>
                                    <tr id="theadBasic">
                                        <td width="5%" id="thead">No</td>
                                        <td width="20%" id="thead">Nama</td>
                                        <td width="20%" id="thead">Username</td>
                                        <td width="20%" id="thead">Parameter</td>
                                        <td width="35%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel4View.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel4ViewModal.php";
                                include "../../../../data/view/editLevel4AccountViewModal.php";
                                include "../../../../data/view/deleteLevel4AccountModal.php";
                                include "../../../../data/view/resetLevel4PasswordViewModal.php";
                                include "../../../../data/view/userLevel4EditRoleViewModal.php";
                            ?>
