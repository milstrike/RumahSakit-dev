...
<html>
    <head>
        ...
        include "../../../../data/editLevel1Pengamat.php";
        include "../../../../data/deleteLevel1Pengamat.php";
        include "../../../../data/resetLevel1Pengamat.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Pengamat Level 1</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel1PengamatView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel1PengamatViewModal.php";
                                include "../../../../data/view/editLevel1PengamatViewModal.php";
                                include "../../../../data/view/deleteLevel1PengamatViewModal.php";
                                include "../../../../data/view/resetLevel1PengamatViewModal.php";
                            ?>
