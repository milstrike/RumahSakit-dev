...
<html>
    <head>
        ...
        include "../../../../data/editLevel4Pengamat.php";
        include "../../../../data/deleteLevel4Pengamat.php";
        include "../../../../data/resetLevel4Pengamat.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">User Pengamat Level 4</li>
                                </ul>
<!--                            <p align="right">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userLevel4PengamatView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userLevel4PengamatViewModal.php";
                                include "../../../../data/view/editLevel4PengamatViewModal.php";
                                include "../../../../data/view/deleteLevel4PengamatViewModal.php";
                                include "../../../../data/view/resetLevel4PengamatViewModal.php";
                            ?>
