...
<html>
    <head>
        ...
        include "../../../../data/editSystemAccount.php";
        include "../../../../data/deleteSystemAccount.php";
        include "../../../../data/resetSystemPassword.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/userSystemView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../../data/view/userSystemViewModal.php";
                                include "../../../../data/view/editSystemAccountViewModal.php";
                                include "../../../../data/view/deleteSystemAccountModal.php";
                                include "../../../../data/view/resetSystemPasswordViewModal.php";
                            ?>
