...
<html>
    <head>
        ...
        include "../../../data/tambahListPenerima.php";
        include "../../../data/editListPenerima.php";
        include "../../../data/deleteListPenerima.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">List Daftar Penerima Khusus</li>
                                </ul>
                                ...
                                <p>
                                    Pada bagian ini dapat berisi beberapa bagian yang mendefinisikan tingkat apakah yang mendapatkan bagian khusus dari sistem. Harus terdefinisikan dahulu di bagian Faktor Pembagi.
                                </p>
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/listPenerimaView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/tambahListPenerimaViewModal.php";
                                include "../../../data/view/editListPenerimaViewModal.php";
                                include "../../../data/view/deleteListPenerimaViewModal.php";
                            ?>
                        </div>
                    </div>
                </div>
