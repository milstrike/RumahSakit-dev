...
<html>
    <head>
        ...
        include "../../../data/changeUserStatus.php";
        include "../../../data/jumpCreateUser.php";
                ...
                <div class="span12">
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                            ...
                            <p align="right">
                                <a href="#pilihRole" data-toggle='modal'><button type="submit" id="edit" name="edit" class="btn btn-mini"><i class="icon-plus-sign"></i>&nbsp;Tambah User</button></a>
                                <a href="../manajemen_role/"><button type="submit" id="edit" name="edit" class="btn btn-mini"><i class="icon-user"></i>&nbsp;Manajemen Role</button></a>
                                <a href="../monitoring_system/"><button type="submit" id="edit" name="edit" class="btn btn-mini"><i class="icon-user"></i>&nbsp;Monitoring User</button></a>
                            </p>    
                            ...
                            <?php
                                include "../../../data/view/tambahUserViewModal.php";
                                ...
                                include "../../../data/view/changeStatusViewModal.php";
                            ?>
