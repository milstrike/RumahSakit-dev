                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Cek Sumber Dana</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-edit"></i>&nbsp;Form Masukan Dana</button></a>
                                </p>    
                                
                                <legend>Pembagian Berdasarkan Ketentuan</legend>
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="20%" id="thead">Bagian</td> 
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/sumberDanaGajiView.php";
                                    ?>
                                </tbody>
                            </table>
                                
                                <legend>Daftar Penerima Khusus</legend>
                                    <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                <thead>
                                    <tr id="theadBasic">
                                        <td width="10%" id="thead">No</td>
                                        <td width="30%" id="thead">Keterangan</td>
                                        <td width="60%" id="thead">Bagian Terbagi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/listStrukturalDanaView.php";
                                    ?>
                                </tbody>
                            </table>
                                
                                <legend>Daftar Penerima Umum</legend>
                                    <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                <thead>
                                    <tr id="theadBasic">
                                        <td width="10%" id="thead">No</td>
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/listUmumDanaView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/tambahDanaViewModal.php";
                            ?>
                        </div>
                    </div>
                </div>
