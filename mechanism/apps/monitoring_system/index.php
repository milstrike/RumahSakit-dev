                            ...
                            <table width="100%" cellpadding="5" cellspacing="5" class="table table-bordered table-hover">
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td id="thead">Tanggal Dibuat</td>
                                        <td id="thead">Login Terakhir</td>
                                        <td id="thead">Logout Terakhir</td>
                                        <td id="thead">IP Akses</td>
                                        <td id="thead">Status</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/monitoringView.php";
                                    ?>
                                </tbody>
                            </table>
                        </div>
