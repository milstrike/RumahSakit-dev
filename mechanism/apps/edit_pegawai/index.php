                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                            ...
                            <form class="form-horizontal" action="" method="post">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="nama" name="nama" type="text" placeholder="Nama Lengkap" class="span6" required="required" value="<?php echo $_SESSION["dataEditNama"];?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="nip">Nomor Induk Pegawai*</label>
                                    <div class="controls">
                                        <input id="nip" name="nip" type="text" placeholder="Nomor Induk Pegawai" class="span6" maxlength="20" required="required" value="<?php echo $_SESSION["dataEditNIP"];?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="perangkat">Unit*</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <button type="submit" id="submit" name="submit" class="btn btn-warning"><i class="icon-user icon-white"></i>&nbsp;<strong>Simpan Perubahan!</strong></button><br/>
                                    </div>
                                </div>
