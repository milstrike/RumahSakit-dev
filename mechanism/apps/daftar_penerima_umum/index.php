...
<html>
    <head>
        ...
        include "../../../data/tambahListPenerimaUmum.php";
        include "../../../data/editListPenerimaUmum.php";
        include "../../../data/deleteListPenerimaUmum.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="../manajemen_pembagian_gaji/">Manajemen Sumber Gaji</a> <span class="divider">/</span></li>
                                    <li class="active">List Daftar Penerima Umum</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah List Daftar Penerima</button></a> 
                                </p>    
                                
                                <p>
                                    Pada bagian ini, hanya boleh berisikan satu daftar saja yang mendefinisikan bagian umum yang akan diterima oleh seluruh pegawai termasuk para pejabat. Harus terdefinisikan di Faktor Pembagi.
                                </p>
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="20%" id="thead">Sumber Gaji</td>
                                        <td width="20%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/listPenerimaViewUmum.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/tambahListPenerimaUmumViewModal.php";
                                include "../../../data/view/editListPenerimaUmumViewModal.php";
                                include "../../../data/view/deleteListPenerimaUmumViewModal.php";
                            ?>
                        </div>
                    </div>
                </div>
