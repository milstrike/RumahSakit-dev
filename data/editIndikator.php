...
$sqlx = "UPDATE u6799722_rumahsakit_dev.master_ikip SET kategori='$kategori', indikator='$indikator' WHERE master_ikip.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);   

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data indikator IKIP";
