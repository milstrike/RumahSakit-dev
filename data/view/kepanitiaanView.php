...
$log_activity = "mengakses data kepanitiaan";
...
$query = mysql("u6799722_rumahsakit_dev", "select * from e_2_kepanitiaan_tim_kerja ORDER BY e_2_kepanitiaan_tim_kerja.poin ASC");
