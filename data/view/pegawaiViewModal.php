...
$counter = 1;
$sql = "select * from u6799722_rumahsakit_dev.data_pegawai ORDER BY data_pegawai.nama ASC";
$query = mysql("u6799722_rumahsakit_dev", "select * from u6799722_rumahsakit_dev.data_pegawai ORDER BY data_pegawai.nama ASC");
