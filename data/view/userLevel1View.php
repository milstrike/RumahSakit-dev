...
$log_activity = "mengakses data user level 1";
...
$counter = 1;
$sql = "select * from user, user_detail where user.id=user_detail.id and user.level=2";
...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        $unit = "Akses Penuh Penilaian ke Penilai Level 2";
        echo 
            "<tr>
