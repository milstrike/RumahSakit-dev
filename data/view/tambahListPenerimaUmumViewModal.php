...
include 'optionStrukturalView.php';
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Tambah Sumber Penerima Umum</h3>
            </div>
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                <p>Pilih Salah satu sumber di bawah ini untuk menentukan sebagai sumber utama yang akan diterima seluruh pegawai</p>
