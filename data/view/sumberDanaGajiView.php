...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        if($danaBagian == NULL){
            ...
            $danaBagian = "Rp".$number_format_vietnam = number_format($danaBagian, 2, ',', '.')."";
        }
        
        $keteranganSumber = getKeteranganDana($id_sumber);
            ...
            <td width='20%' id='thead'>".$danaBagian."</td></tr>";            
            $counter = $counter + 1;
    }
}
else{
...
function getKeteranganDana($id_sumber){
