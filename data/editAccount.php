...
list($jabatanName, $jabatan_id) = explode("-", $jabatan);

$jabatan = $jabatanName;
$levelUser = $jabatan_id;
...
$sqlx = "UPDATE u6799722_rumahsakit_dev.user SET password='$password2', pass_umask='$password', level='$levelUser' WHERE user.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    


$sqln = "UPDATE u6799722_rumahsakit_dev.user_detail SET nama='$namalengkap', jabatan='$jabatan', telepon='$telepon' WHERE user_detail.id='$id'";
$queryn = mysql("u6799722_rumahsakit_dev", $sqln); 

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data akun user";
