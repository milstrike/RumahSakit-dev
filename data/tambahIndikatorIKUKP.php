...
$sqlx = "INSERT INTO u6799722_rumahsakit_dev.master_ikukp (id, kategori, indikator, ci, target_a, target_b, nilai, bobot, sum) VALUES (NULL, '$kategori', '$indikator', '$ci', '$target_a', '$target_b', '$nilai', '$bobot', '$sum')";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx); 

$log_username = $_SESSION['umask'];
$log_activity = "tambah indikator IKUKP";
