...
$sqlx = "UPDATE u6799722_rumahsakit_dev.b_1_pendidikan SET keterangan='$keterangan', poin='$poin' WHERE b_1_pendidikan.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx); 

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data pendidikan";
