...
$idEdit=$_POST['idEdit'];
$idSumberGaji = $_POST['sumberBagianEdit'];

$sqlx = "UPDATE daftar_penerima_umum SET id_sumber='$idSumberGaji' WHERE id='$idEdit'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx); 

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data List Penerima Umum";
