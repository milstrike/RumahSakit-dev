...
$sqlx = "DELETE FROM u6799722_rumahsakit_dev.detail_kepanitiaan WHERE detail_kepanitiaan.id='$id' AND detail_kepanitiaan.id_pegawai='$id_pegawai'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    

$log_username = $_SESSION['umask'];
$log_activity = " menghapus anggota kepanitiaan";
