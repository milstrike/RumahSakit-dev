...
$sqlx = "UPDATE u6799722_rumahsakit_dev.a_2_kepegawaian SET keterangan='$keteranganKepegawaian', poin='$poinKepegawaian' WHERE a_2_kepegawaian.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data kepegawaian";
