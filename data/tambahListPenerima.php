...
if (empty($_POST['strukturalTarget']) || empty($_POST['sumberBagian'])) {
...
$strukturalTarget = $_POST['strukturalTarget'];
$sumberBagian = $_POST['sumberBagian'];

    
$sqlx = "INSERT INTO daftar_penerima (id, id_struktural, id_sumber) VALUES (NULL, '$strukturalTarget', '$sumberBagian')";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);   

$log_username = $_SESSION['umask'];
$log_activity = "Menambahkan Daftar Penerima";
