...
$sqlx = "UPDATE u6799722_rumahsakit_dev.perangkat_rs SET keterangan='$namaPerangkat', level_risk='$level_risk', poin_risk='$poin_risk', level_emergency='$level_emergency', poin_emergency='$poin_emergency', change_date=NULL WHERE perangkat_rs.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx); 

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data unit";
