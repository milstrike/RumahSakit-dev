...
$sqlx = "UPDATE u6799722_rumahsakit_dev.e_1_struktural SET keterangan='$keterangan', poin='$poin' WHERE e_1_struktural.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);   

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data struktural";
