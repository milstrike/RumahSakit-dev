...
$sqlx = "UPDATE u6799722_rumahsakit_dev.daftar_kepanitiaan SET nama_kepanitiaan='$namaKepanitiaan', detail_kepanitiaan='$keteranganKepanitiaan' WHERE daftar_kepanitiaan.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data daftar kepanitiaan";
