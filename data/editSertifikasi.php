...
$sqlx = "UPDATE u6799722_rumahsakit_dev.b_2_sertifikasi SET keterangan='$keterangan', poin='$poin' WHERE b_2_sertifikasi.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data sertifikasi";
