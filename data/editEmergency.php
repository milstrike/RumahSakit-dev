...
$sqlx = "UPDATE u6799722_rumahsakit_dev.d_2_tingkat_emergensi SET keterangan='$keterangan', poin='$poin' WHERE d_2_tingkat_emergensi.id='$id'";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);  

$log_username = $_SESSION['umask'];
$log_activity = " mengedit data emergency";
