...
$sqlx = "INSERT INTO u6799722_rumahsakit_dev.daftar_kepanitiaan (id, nama_kepanitiaan, detail_kepanitiaan, change_date) VALUES (NULL, '$namaKepanitiaan', '$keteranganKepanitiaan', NULL)";
$queryx = mysql("u6799722_rumahsakit_dev", $sqlx);    

$log_username = $_SESSION['umask'];
$log_activity = "tambah daftar kepanitiaan";
