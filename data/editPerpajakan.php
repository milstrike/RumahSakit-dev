...
$pajakKepegawaian=$_POST['poinKepegawaian'];
if($pajakKepegawaian > 0){
    $pajakKepegawaian = $pajakKepegawaian/100;    
}
else{
    $pajakKepegawaian = 0;
}

    $sqlx = "UPDATE u6799722_rumahsakit_dev.a_2_kepegawaian SET pajak='$pajakKepegawaian' WHERE a_2_kepegawaian.id='$id'";
    $queryx = mysql("u6799722_rumahsakit_dev", $sqlx);
    
    $log_username = $_SESSION['umask'];
$log_activity = " mengedit data pajak";
...
$queryop = mysql("u6799722_rumahsakit_dev", $sqlop);
    ...
    $pesanBerhasil = '<div class="alert alert-success fade in"><button type="button" class="close" data-dismiss="alert">&times;</button>Sukses mengubah data pajak!</div>';
